...
export default function Links({ className }) {
    return (
        <div className={cn(className, "flex gap-8")}>
            ...
            <a
                href="https://www.linkedin.com/in/janus-bardrum-5727281b5"
                className="group"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="scale-0 group-hover:scale-85 transition absolute ease-in translate-y-4 -translate-x-6 font-medium text-sm text-base-white bg-main-base p-2 rounded-md ">
                    LinkedIn
                </p>
            </a>
        </div>
