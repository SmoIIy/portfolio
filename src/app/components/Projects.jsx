...
import sea from "@/app/assets/seabreak.png";
    ...
    return (
        <section className="min-h-block bg-base-white md:p-10 p-2">
            ...
            <div className="md:max-w-7xl mx-auto  min-h-block grid lg:grid-cols-3 grid-cols-1 place-items-center p-4 md:p-0 text-center gap-4">
                ...
                /> */}
                <Project
                    anchor="https://seabreak.dk"
                    title="Seabreak"
                    body="Developing a portfolio site for Jacob Jelsings Seabreak project, which aims to invest in the preservation of the natural sea around denmark"
                    src={sea}
                />
            </div>
        </section>
